                ...
                <div class="card-body">
                    ...
                    <form id="registro" name="registro" class="mb-2" method="post">
                        ...
                        <input type="text" class="form-control" placeholder="Nombre de usuario" id="usnombre" name="usnombre" required>
                            ...
                            <input type="date" id="usfecnac" name="usfecnac" class="form-control mt-2" placeholder="Fecha de nacimiento" required>
                        
                            <input type="email" id="usmail" name="usmail" class="form-control mt-2" placeholder="Email" required>
